// National Bank of Moldova exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MDL', { apiKey }). */
